...
/***/ (function(module, exports) {
	...
	function init() {
	    ...
	    function setStyle(ctx) {
	        ...
	        gradient.addColorStop(0, '#7ee2e8');
	        gradient.addColorStop(0.5, '#89b5f0');
	        gradient.addColorStop(1, '#c3a7ec');
	    ...
	    function painter(ctx) {
	        ...
	        return function () {
	            ...
	            ctx.beginPath();
	            arr[0] = arr[0] + speed;
	            ctx.moveTo(0, h + 40 * Math.sin(p * arr[0]));
	            for (var i = 1; i < n; i++) {
	                arr[i] = arr[i] + speed;
	                ctx.lineTo((i + 1) * width / n, h + 20 * Math.sin(p * arr[i]));
	            }
	            ctx.lineTo(width, height);
	            ctx.lineTo(0, height);
	            ctx.lineTo(0, h + 40 * Math.sin(p * arr[0]));
	            ctx.fill();
	        };
	    }
	    // Event handling
	    ...
	    function animate(fn) {
	        ...
	        requestAnimationFrame(animate.bind(null, fn));
	    }
